...
const ModuleClasses_REST_API_URL =
  "http://localhost:8080/api/admin/module-classes";
const ClassStudents_REST_API_URL =
  "http://localhost:8080/api/admin/module-classes-students";
const ModuleClassInfo_REST_API_URL =
  "http://localhost:8080/api/admin/module-classes-info";
...
class AdminService {
  ...
  getSchedules() {
    return axios.get(ClassSchedule_REST_API_URL);
  }

  deleteSchedule(scheduleId) {
    return axios.delete(ClassSchedule_REST_API_URL + "/" + scheduleId);
  }

  addModule(schedule) {
    return axios.post(ClassSchedule_REST_API_URL, module);
  }
}
