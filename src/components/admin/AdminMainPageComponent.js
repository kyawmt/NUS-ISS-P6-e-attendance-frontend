        ...
        return (
          ...
          <div className="container">
            <div className="row align-items-center mt-4 d-inline-flex justify-content-center row-cols-3">
                ...
                <div className="col col-lg-3 d-inline-flex justify-content-center m-1 customMinWidth">
                <div className="card white darken-1">
                <a href={"./ListModule"} className="v-align"><img src={Modules} alt="Modules" className="img-fluid" height="200" width="200"/></a>
                </div>
                </div>

                <div className="col col-lg-3 d-inline-flex justify-content-center m-1 customMinWidth">
                <div className="card white darken-1">
                <a href={"./ListClassSchedule"} className="v-align"><img src={ClassSchedule} alt="ClassSchedule" className="img-fluid" height="200" width="200"/></a>
                </div>
                </div>

                <div className="col col-lg-3 d-inline-flex justify-content-center m-1 customMinWidth">
                <div className="card white darken-1">
                <a href={"./ListClass"} className="v-align"><img src={Enrolments} alt="Enrolments" className="img-fluid" height="200" width="200"/></a>
                </div>
                </div>
                
                <div className="col col-lg-3 d-inline-flex justify-content-center m-1 customMinWidth">
                <div className="card white darken-1">
                <a href={"./ListAttendance"} className="v-align" ><img src={Attendance} alt="Attendance" className="img-fluid" height="200" width="200"/></a>
                </div>
                </div>

                <div className="col col-lg-3 d-inline-flex justify-content-center m-1 customMinWidth" >
                <div className="card white darken-1">
                <a href={"./StudentLeaveApplication"} className="v-align" ><img src={StudentLeaveApplication} alt="StudentLeaveApplication" className="img-fluid" height="200" width="200"/></a>
                </div>
                </div>
            </div>
          </div>
